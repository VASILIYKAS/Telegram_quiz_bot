...
QUESTIONS_FOLDERS=имя_папки_с_вопросами
...
- `QUESTIONS_FOLDERS` - имя папки, в которой находятся файлы с вопросами. По умолчанию используется папка "questions", но вы можете указать свою.
